%
% NOTE: This is for calculating the extreme scenarios for solar data
%
% HIST:  - 27 Sep, 2021: Created by Patra
%=========================================================================
function PCA_ExtremeScenarioSolar =PCA_ExtremeScenarioSolar(Array)
...
for i=4:scenario_num(1)
    check=length(find((b_array(i,7:18)<bm(7:18))<1));
    avgfluc=0.0;
    for hours=1:23
...
PCA_ExtremeScenarioSolar=point;
end
